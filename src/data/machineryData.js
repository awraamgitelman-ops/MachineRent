// Comprehensive Catalog Dataset for AGRORENTEX (106 products)
...
export const MACHINERY_DATA = [
  ...
  },
  {
    ...
    "name": "Жатка зернова прямого комбайнування ЖУ-6",
    "slug": "zhatka-zernovaya-pryamogo-kombajnyrovanyya-zhu-6",
    "brand": "ХМЗ (Херсонський машинобудівний завод)",
    "model": "ЖУ-6",
    ...
    "shortDescription": "Універсальна зернова жатка ЖУ-6 прямого комбайнування. Призначена для скошування та обмолоту зернових колосових, зернобобових культур та насінників трав.",
    "fullDescription": "Зернова жатка ЖУ-6 виробництва Херсонського машинобудівного заводу (ХМЗ) є перевіреним часом надійним рішенням для збирання врожаю зернових колосових, зернобобових та круп'яних культур. Жатка оснащена планетарним приводом ріжучого апарату типу Schumacher, посиленим мотовилом з гідроприводом та надійним шнеком із висувними пальцями. Агрегат адаптується як до вітчизняних комбайнів (Славутич, Дон-1500, Скіф, Лан), так і до імпортної техніки John Deere, CLAAS, New Holland, Case IH за допомогою універсальних перехідних рамок.",
    "specs": {
      "Виробник": "Херсонський машинобудівний завод (ХМЗ), Україна",
      "Модель": "ЖУ-6",
      "Робоча ширина захвату": "6.0 м",
      "Ріжучий апарат": "Планетарний привід ножа типу Schumacher",
      "Частота зрізів": "до 1 200 зріз/хв",
      "Сумісність з комбайнами": "Славутич, Дон-1500, Скіф, Лан, John Deere, CLAAS, New Holland, Case IH",
      "Стан": "В наявності (пройшла повну передпродажну підготовку)"
    }
  },
  {
    ...
    "brand": "Бердянські жатки (John Greaves)",
    "model": "ЖЗБ-4,2",
    "machineryType": "zhatky",
    "activityType": "grain",
    "pricing": {
    ...
    "shortDescription": "Спеціалізована зернобобова навісна жатка ЖЗБ-4,2. Створена для низького скошування та укладання у валок полеглих бобових (горох, соя, квасоля) та круп'яних культур.",
    "fullDescription": "Жатка зернобобова ЖЗБ-4,2 виробництва ПАТ «Бердянські жатки» (John Greaves) призначена для скошування та укладання у валок зернобобових культур (гороху, квасолі, сої), насінників цукрових буряків, а також сплутаних та полеглих зернових і трав. Конструкція жатки забезпечує мінімальну висоту зрізу завдяки плаваючим копіюючим башмакам і спеціальному безпальцевому ріжучому апарату, що знижує втрати бобів до мінімуму.",
    "specs": {
      "Виробник": "ПАТ «Бердянські жатки» (John Greaves), Україна",
      "Модель": "ЖЗБ-4,2",
      "Робоча ширина захвату": "4.2 м",
      "Конструкція ріжучого апарату": "Безпальцевий низькопрофільний зріз на плаваючих башмаках",
      "Висота зрізу": "від 35 мм (копіювання мікрорельєфу)",
      "Агрегатування": "Самохідні зернозбиральні комбайни та шасі (через адаптер)",
      "Стан": "В наявності (відкалібрована, готова до сезону)"
    }
  },
  {
  ...
  },
  {
    ...
    "activityType": "grain",
    "pricing": {
      "purchasePriceUah": 54500,
      "pricePerShiftUah": 12500,
      "pricePerHaUah": 694
    },
    "images": [
      "/assets/products/zhatka-zhu-6-psm.jpg"
    ],
    "shortDescription": "Універсальна жатка ЖУ-6 з приставкою ПСМ (пристосування для збирання соняшника). Забезпечує високу швидкість збирання та мінімальні втрати насіння.",
    "fullDescription": "Жатка універсальна ЖУ-6 ПСМ виробництва машинобудівного комплексу «Югтехагро» / ХМЗ призначена для прямого комбайнування та швидкісного збирання соняшника в усіх зонах вирощування. Комплектується спеціальними ліфтерами-руслоутворювачами, протягувальним валом та модифікованим мотовилом. Швидко монтується та забезпечує зрізання виключно кошиків соняшника без перевантаження молотарки комбайна зайвою листостебловою масою.",
    "specs": {
      "Виробник": "ТОВ «Югтехагро» / Херсонський машинобудівний завод, Україна",
      "Модель": "ЖУ-6 ПСМ",
      "Робоча ширина захвату": "6.0 м",
      "Призначення": "Збирання соняшника, сої та зернових колосових культур",
      "Ріжучий апарат": "Система Schumacher з високою частотою подвійних ходів ножа",
      "Сумісність": "Claas, John Deere, Case IH, New Holland, Славутич, Дон-1500",
      "Стан": "В наявності"
    }
  }
];
