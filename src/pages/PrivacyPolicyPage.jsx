...
export default function PrivacyPolicyPage() {
  useEffect(() => {
    ...
    const schemaData = {
      ...
      "@type": "WebPage",
      "name": "Політика конфіденційності | AGRO RENTEX",
      "url": "https://agrorentex.com/privacy-policy",
      "description": "Політика конфіденційності та захисту персональних даних компанії AGRO RENTEX.",
      "publisher": {
        "@type": "Organization",
        "name": "AGRO RENTEX",
    ...
    setPageSeo({
      title: 'Політика конфіденційності | AGRO RENTEX',
      description: 'Ознайомтеся з Політикою конфіденційності та захисту персональних даних AGRO RENTEX відповідно до законодавства України.',
      ...
      <div className="container" style={{ maxWidth: '900px', paddingTop: '40px' }}>
        ...
        <div style={{
          ...
          <section>
            ...
            <p>
              AGRO RENTEX може збирати та обробляти такі категорії персональних даних Користувачів:
            </p>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <li>Координація виїзду інженерно-сервісної служби AGRO RENTEX у господарство замовника;</li>
          ...
          <section>
            ...
            <p>
              AGRO RENTEX застосовує комплекс сучасних правових, організаційних та технічних заходів безпеки для захисту персональних даних від несанкціонованого або випадкового доступу, знищення, перекручення, блокування чи копіювання.
            </p>
            <p>
          ...
          <section style={{ backgroundColor: '#fafafa', border: '1px solid #e5e5e5', padding: '24px', borderRadius: '6px' }}>
            ...
            <p style={{ marginBottom: '12px' }}>
              З усіх питань щодо цієї Політики або для зміни/видалення ваших персональних даних, будь ласка, звертайтесь:
            </p>
