...
export default function PublicOfferPage() {
  useEffect(() => {
    ...
    const schemaData = {
      ...
      "description": "Договір публічної оферти купівлі-продажу та оренди сільськогосподарської техніки AGRO RENTEX.",
      "publisher": {
        "@type": "Organization",
        "name": "AGRO RENTEX",
    ...
    setPageSeo({
      title: 'Публічна оферта | AGRO RENTEX – Оренда та продаж с/г техніки',
      description: 'Офіційний договір публічної оферти компанії AGRO RENTEX: умови придбання, оренди, доставки, гарантії та сервісного обслуговування с/г техніки.',
      ...
      <div className="container" style={{ maxWidth: '900px', paddingTop: '40px' }}>
        ...
        <div style={{
          ...
          <section>
            ...
            <p>
              В порядку та на умовах, визначених цією Офертою, AGRO RENTEX зобов'язується:
            </p>
          ...
          <section>
            ...
            <p>
              3.1. Замовлення формується Замовником шляхом вибору необхідного товару чи послуги в каталозі на Сайті, заповнення онлайн-форми заявки або через узгодження специфікації з менеджером AGRO RENTEX за контактними номерами телефонів.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              4.2. Оплата здійснюється у безготівковій формі на банківські реквізити AGRO RENTEX згідно з виставленим рахунком або за іншою письмовою домовленістю сторін.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              5.1. Доставка великогабаритної польової та збиральної техніки здійснюється спеціалізованими низькорамними тралами безпосередньо у господарство Замовника по всій території України або шляхом самовивозу з нашого майданчика (м. Рівне, с. Колоденка).
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              6.1. На всю нову техніку, обладнання складського зберігання та відреставровані транспортери AGRO RENTEX надає офіційну гарантію відповідно до заводських нормативів.
            </p>
            <p>
              6.2. У разі виникнення технічної несправності в процесі оренди, сервісна служба AGRO RENTEX забезпечує виїзд інженера для оперативної діагностики та усунення поломки або заміни агрегату.
            </p>
          </section>
          ...
          <section style={{ backgroundColor: '#fafafa', border: '1px solid #e5e5e5', padding: '24px', borderRadius: '6px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '14px' }}>
              <div><strong>Найменування:</strong> AGRO RENTEX (Польова та складська с/г техніка)</div>
